...
#+begin_src emacs-lisp
  (setq explicit-shell-args '("-l"))
  (defvar emacs-shell-program (or (getenv "ESHELL") (getenv "SHELL")))
...
#+begin_src emacs-lisp
  ...
  ;; (global-set-key (kbd "<f7>") 'named-term)
  (global-set-key (kbd "M-<f7>") 'ansi-term)

  (global-set-key (kbd "<f8>") 'magit-status)
  (global-set-key (kbd "M-<f8>") 'magit-file-dispatch)

  ;; (global-set-key (kbd "<f9>") 'xxx)
  ;; (global-set-key (kbd "M-<f9>") 'xxx)
...
#+begin_src emacs-lisp
  (define-prefix-command 'emy-mega-map)
  (keymap-global-set "M-]" 'emy-mega-map)

  (define-prefix-command 'emy-mega-buffer-map)
  (keymap-set emy-mega-map "b" 'emy-mega-buffer-map)
  (keymap-set emy-mega-buffer-map "s" 'emw/scratch-goto)
  (keymap-set emy-mega-buffer-map "c" 'emw/scratch-new)
  (keymap-set emy-mega-buffer-map "n" 'emw/scratch-new)
  (keymap-set emy-mega-buffer-map "v" 'add-file-local-variable)
  (keymap-set emy-mega-buffer-map "p" 'add-file-local-variable-prop-line)
...
#+begin_src emacs-lisp
  (define-prefix-command 'emy-menu-map)
  (keymap-global-set "M-=" 'emy-menu-map)

  (keymap-set emy-menu-map "m" 'compile)
#+end_src
